...
execute as @a[scores={stats=1..}] run tellraw @s ["",{"text":"Wins: ","color":"green"},{"score":{"name":"@s","objective":"win"},"color":"gold"},{"text":"","color":"green"}]
...
execute as @a[scores={stats=1..}] run tellraw @s ["",{"text":"Jump and Runs: ","color":"green"},{"score":{"name":"@s","objective":"jump_and_run"},"color":"gold"},{"text":"","color":"green"}]
