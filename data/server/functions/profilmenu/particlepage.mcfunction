...
clear @s player_head{display:{Name:'{"text":"Info","color":"green","bold":true,"italic":false}',Lore:['{"text":"Stelle hier Partikel ein.","color":"white","italic":false}']}}
...
execute unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:18b,id:"minecraft:arrow"}]}] run scoreboard players set @s profilmenu 4
...
execute if score @s particle-flame matches 0 unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:19b,id:"minecraft:red_dye"}]}] run scoreboard players set @s profilmenu 8
...
execute if score @s particle-flame matches 2 unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:19b,id:"minecraft:lime_dye"}]}] run scoreboard players set @s profilmenu 8
...
execute if score @s particle-green matches 0 unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:21b,id:"minecraft:red_dye"}]}] run scoreboard players set @s profilmenu 8
...
execute if score @s particle-green matches 2 unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:21b,id:"minecraft:lime_dye"}]}] run scoreboard players set @s profilmenu 8
...
execute if score @s particle-squid matches 0 unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:23b,id:"minecraft:red_dye"}]}] run scoreboard players set @s profilmenu 8
...
execute if score @s particle-squid matches 2 unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:23b,id:"minecraft:lime_dye"}]}] run scoreboard players set @s profilmenu 8
...
execute if score @s particle-rain matches 0 unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:25b,id:"minecraft:red_dye"}]}] run scoreboard players set @s profilmenu 8
...
execute if score @s particle-rain matches 2 unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:25b,id:"minecraft:lime_dye"}]}] run scoreboard players set @s profilmenu 8
