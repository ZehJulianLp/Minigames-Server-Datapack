...
execute unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:11b,id:"minecraft:ender_eye"}]}] run playsound minecraft:block.amethyst_block.place master @s ~ ~ ~ 1 1 1
execute unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:11b,id:"minecraft:ender_eye"}]}] run tellraw @s ["",{"text":"[Server] ","bold":true,"italic":true,"color":"dark_blue"},{"text":"Seite aktualisiert!","color":"gold"}]
execute unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:11b,id:"minecraft:ender_eye"}]}] run scoreboard players set @s profilmenu 2
execute unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:11b,id:"minecraft:ender_eye"}]}] run clear @s ender_eye

execute as @s[team=Admin] run item replace entity @e[type=chest_minecart,distance=..3] container.10 with redstone_block{display:{Name:'{"text":"Dein Rang:","color":"gold","bold":true, "italic": false}',Lore:['{"text":"Admin","color":"red","italic": false}']}}
execute as @s[team=BPremium] run item replace entity @e[type=chest_minecart,distance=..3] container.10 with diamond{display:{Name:'{"text":"Dein Rang:","color":"gold","bold":true, "italic": false}',Lore:['{"text":"Premium","color":"aqua","italic": false}']}}
execute as @s[team=Player] run item replace entity @e[type=chest_minecart,distance=..3] container.10 with iron_ingot{display:{Name:'{"text":"Dein Rang:","color":"gold","bold":true, "italic": false}',Lore:['{"text":"Spieler","color":"green","italic": false}']}}
