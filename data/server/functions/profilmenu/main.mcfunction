...
execute if score @s profilmenu matches 2 run item replace entity @e[type=chest_minecart,distance=..3] container.15 with gold_nugget
execute if score @s profilmenu matches 2 run item replace entity @e[type=chest_minecart,distance=..3] container.16 with clock
