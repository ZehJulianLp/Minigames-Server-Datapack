...
clear @s player_head{display:{Name:'{"text":"Sicher?","color":"red","bold":true,"italic":false}',Lore:['{"text":"Möchtest du wirklich deine komplette Spielzeit zurücksetzen?","color":"white","italic":false}']}}
...
execute unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:15b,id:"minecraft:red_dye"}]}] run scoreboard players set @s profilmenu 4
...
execute unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:11b,id:"minecraft:lime_dye"}]}] run function server:reset_playtime
execute unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:11b,id:"minecraft:lime_dye"}]}] run tellraw @s ["",{"text":"[Settings] ","bold":true,"italic":true,"color":"dark_blue"},{"text":"Deine Spielzeit wurde zurückgesetzt!","color":"red"}]
execute unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:11b,id:"minecraft:lime_dye"}]}] run clear @s lime_dye
execute unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:11b,id:"minecraft:lime_dye"}]}] run scoreboard players set @s profilmenu 4