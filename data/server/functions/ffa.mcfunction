...
execute as @e[type=item,nbt={Item:{id:"minecraft:bow",Count:1b,tag:{FFA4:1b}}}] at @s run item replace entity @p hotbar.1 with bow{Unbreakable:1b,Enchantments:[{id:"minecraft:power",lvl:2s},{id:"minecraft:punch",lvl:1s},{id:"minecraft:infinity",lvl:1s}]} 1
execute as @e[type=item,nbt={Item:{id:"minecraft:bow",Count:1b,tag:{FFA4:1b}}}] at @s run item replace entity @p hotbar.2 with crossbow{Unbreakable:1b,ChargedProjectiles:[{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:2b,Explosions:[{Type:1,Flicker:1b,Colors:[I;16711680],FadeColors:[I;16756754]}]}}},{},{}],Charged:1b,Enchantments:[{id:"minecraft:quick_charge", lvl:2s}]} 1
...
execute as @e[type=item,nbt={Item:{id:"minecraft:bow",Count:1b,tag:{FFA4:1b}}}] at @s run item replace entity @p weapon.offhand with firework_rocket{Fireworks:{Flight:2b,Explosions:[{Type:1,Flicker:1b,Colors:[I;16711680],FadeColors:[I;16756754]}]}} 32
execute as @e[type=item,nbt={Item:{id:"minecraft:bow",Count:1b,tag:{FFA4:1b}}}] at @s run item replace entity @p armor.head with skeleton_skull{Enchantments:[{id:"minecraft:protection",lvl:2s}],AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:2,Operation:0,UUID:[I;-1998587278,1630291112,-1708438199,1486698068],Slot:"head"}]} 1
...
execute as @e[type=item,nbt={Item:{id:"minecraft:bow",Count:1b,tag:{FFA4:1b}}}] at @s run item replace entity @p hotbar.8 with minecraft:arrow 1
