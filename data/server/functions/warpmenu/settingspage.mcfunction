...
execute unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:11b,id:"minecraft:white_wool"}]}] run scoreboard players set @s warpmenu 6
...
execute unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:13b,id:"minecraft:tipped_arrow"}]}] run scoreboard players set @s warpmenu 8
...
execute unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:15b,id:"minecraft:gold_nugget"}]}] run scoreboard players set @s warpmenu 10
...
execute unless entity @e[type=chest_minecart,distance=..3,nbt={Items:[{Slot:16b,id:"minecraft:clock"}]}] run scoreboard players set @s warpmenu 12
